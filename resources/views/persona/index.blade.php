    ...
    <table id="personas" class="table table-striped table-bordered" style="width: 100%">
        <thead class="bg-primary text-white">
            <tr>
                ...
                <th style="background-color: #4b545c" scope="col">Apellido</th>
                <th style="background-color: #4b545c" scope="col">Tipo de Usuario</th>
                <th style="background-color: #4b545c" scope="col">Estado</th>
                <th style="background-color: #4b545c" scope="col">Foto</th>
                @if (Request::is('administradores*'))
