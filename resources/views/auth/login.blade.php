...
<body background="{{ asset('welcome/img/logo8.jpg') }}">
...
<div class="page">
  <div class="container">
    <div class="left">
      ...
      <img src={{ asset('welcome/img/logo9.png') }} style="left: 500px" class="log"> 
      <div class="eula">Porfavor introduce tus datos de usuario para poder utilizar todas las herramientas del software!</div>
    </div>
    <div class="right">
